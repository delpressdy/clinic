            ...
            <div class="row"> 
                ...
                <div class="row">
                    ...
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                                    <h3 class="title text-center">Please Click Next Bellow</h3>
                ...
                <div class="row">
                    ...
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="title text-center margin">Leave the password blank, thanks :)</h3>
                                <br>
                                ...
                                <form action="#" method="post" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="database" class="form-control" id="database" placeholder="e.g cecilia_db / stacecilia_db" value="<?= (!empty($_POST['database'])?$_POST['database']:null) ?>">
                                    </div> 
                                    <div class="form-group">
                                        <label for="username">Username </label>
                                        <input type="text" name="username" class="form-control" id="username" value="root" readonly>
                                    </div> 
                                    <div class="form-group">
                                        <label for="password">Password </label>
                                        <input type="text" name="password" class="form-control" id="password" placeholder="Leave me blank!" value="<?= (!empty($_POST['password'])?$_POST['password']:null) ?>" readonly>
                                    </div>  
                                    <div class="form-group">
                                        <label for="hostname">Host Name </label>
                                        <input type="text" name="hostname" class="form-control" id="hostname" placeholder="Host Name"  value="<?= (!empty($_POST['hostname'])?$_POST['hostname']:"localhost") ?>" readonly>
                                    </div>  
                                    <div class="divider"></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="text-center hide" id="btn-complete">
                                    <a href="index.php" class="btn cbtn">Click to start!</a>
                                </div>
