                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input required="" autocomplete="off" value="<?php echo $invo->patient_phone;?>" name="phone" id="phone" class="form-control" type="text" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input required="" value="<?php echo $invo->family_name;?>" name="patient_name" id="patient_name" class="form-control" type="text" readonly> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input required="" name="address" id="address" value="<?php echo $invo->address;?>" class="form-control" type="text" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                           <input class="form-control" size="50" name="date" id="date" required="" value="<?php echo $invo->date_time;?>" type="text" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <option value="" ><?php echo 'Midwife'?></option>
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tfoot>
                                    ...
                                    <input id="dueAmmount" class="form-control text-right" name="due_amount" value="<?php echo $invo->due;?>" readonly="readonly" type="hidden">
            ...
            $.ajax({
                ...
                'success': function(data){ 
                    ...
                    if (data.patient_id) {
                        ...
                        $(".invlid_patient_id").text('Patient Record Found!').addClass("text-success");
                       
                    } else {
                        $('#csc').removeClass('text-success');
                        $(".invlid_patient_id").text('No record in the database!').addClass("text-danger");
                    }
                }, error   : function() {
                    alert('failed!');
                } 
