                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label class=" control-label">Mr/Mrs</label>
                                    <div class="">
                                        <input type="text" name="title" class="form-control" value="<?php echo @$old->title;?>"  placeholder="Mr/Mrs." required autofocus> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="text" name="given_name" class="form-control" value="<?php echo @$old->given_name;?>" placeholder="First Name" > 
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="row">
                               ...
                               <div class="form-group col-md-8">
                                ...
                                <div class="form-group col-md-4">
                                    <label class=" control-label">Province/Municipality</label>
                                    <div class="">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-4">
                            ...
                            <fieldset>
                                <label><h2 style="color: red;"><?php echo display('emergency_contact')?></h2></label>
                            ...
                            <fieldset>
                                <label> <h2 style="color: red;">MEDICAL INFORMATION</h2></label><br>
                                ...
                                <div class="row">
                                    ...
                                    <p style="color: red">&nbsp;&nbsp;&nbsp;&nbsp;Please select Illness as following</p>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-12">
                                        <br><br>
                                        <label class="control-label">Do you Consider yourself to be in a high risk group for infectious diseases?</label>
