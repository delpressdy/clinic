                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover dt-responsive" id="appointment">
                            <thead>
                                <tr>
                                    ...
                                    <th class="all" style="border-radius: 10px; color: white; background-color: red;"><?php echo 'Note'; ?></th>
                                    <th class="all"><?php echo 'Schedule' ?></th>
                            ...
                            <tbody>
                                ...
                                <tr <?php echo ($result)?'style="background-color:  rgb(19, 203, 21)"':''?>>
                                    ...
                                    <td style="border-radius: 10px; color: white; background-color: red;"><?php echo $value->problem;?></td>
