                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3>Sta. Cecilia MJ OB Midwife Lying in Clinic Corp.</h3>
                            </div>
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="eml" placeholder="<?php echo display('email');?>" name="email" type="text" autofocus required>
                            ...
                            <small>Are you a guest? <br>
                                Username: <strong class="text-danger">guest</strong>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Password: <strong class="text-danger">123456</strong>
                            </small>
                        </form>
