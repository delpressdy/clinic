                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Select Midwife :</label>
                                <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo 'Time per patient:';?> :</label>
                                <div class="col-md-5">
                                    <div class=" input-daterange">
                                        <input type="text" name="p_time" class="form-control" placeholder="Set patient time">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo 'Availability';?> :</label>
                                <div class="col-md-5" >
