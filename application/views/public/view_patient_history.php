    ...
    <div class="container">
        <div class="row top-bar" style="border-bottom: 7px double #EAEAEA;">
            <div class="left-text pull-left">
                <p style="color:#fff;"><b><?php echo 'PATIENT HISTORY';?></b> </p>
            </div>  
        </div>
    </div>
        ...
        <div class="header-right-info pull-left clearfix">
            <div class="single-header-info">
                <h4>
                    <strong><?php echo 'Name'?> : </strong><?php echo @$p_info->family_name .', '. @$p_info->given_name ;?></p>
                    ...
                    <p><strong><?php echo 'Blood Type';?> : </strong><?php echo $p_info->blood_group;?></p>
