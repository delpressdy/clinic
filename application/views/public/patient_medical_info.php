            ...
            <div class="container">
                <div class="row details-content">
                    <div class="patient-details text-center">
                        <h1><?php echo @$info->family_name .' '. @$info->given_name ;?></h1>
                        &nbsp;<small class="text-danger"><?php echo @$info->blood_group;?></small>
                        &nbsp;| <small class="text-danger"><?php echo @$info->birth_date;?></small>
                        &nbsp;| <small class="text-danger"><?php echo @$info->sex;?> </small>
                        &nbsp;| <small class="text-danger"><?php echo @$info->mobile_number;?></small>
