        ...
        <div class="container">
            <div class="row top-bar">
                <div class="left-text pull-left">
                    <p><b><?php echo 'Date'?>  : <?php echo date('D-M-d')?></p>
                </div>  

                <div class="social-icons pull-right">
                    <ul>
                        <li><button class="btn btn-success" onClick="window.print()">Print this page</button></li>
                    </ul>
                </div> 
            </div>
        </div>
        <div class="container header">
            <div class="header-title text-center"><h2><strong class="text-success">Sta. Cecilia MJ-OB Midwife Lying in Clinic Corp.</strong></h2></div>
            <br><br>   
            <div class="logo pull-left">
               <div class="single-header-info">
                    ...
                    <div class="content">
                        <h3>EMAIL</h3>
                        <p><b><?php echo $email->details;?></b></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="information-details">
                            <ul>
                                ...
                                <li>Note :<span class="pull-right"><?php echo $print->problem;?></span></li>
                                <li>Date :<span class="pull-right"><?php echo $print->date;?></span></li>
                                <li>Time :<span class="pull-right"><?php echo $print->sequence;?></span></li>
                                <li>Midwife :<span class="pull-right"><?php echo $print->doctor_name;?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
